<template>
  <div class="container-fluid text-center bg-black main">
    <h2 class="display-3">User Profile:</h2>
    ...
    <div class="card text-center mx-auto">
      ...
      <div class="row">
        ...
        <div class="mb-3 col-3">
          <h2 class="display-6 mb-1">User Role:</h2>
          <h3 class="fs-3">
        ...
        <div class="mb-3 col-3">
          <h2 class="display-6 mb-1">Email:</h2>
          <h3 class="fs-3">
            {{ $store.state.user?.emailAdd }}
          </h3>
        </div>
        <div class="mb-3 col-3">
          <h2 class="display-6 mb-1">Password:</h2>
          <h3 class="fs-3">
      ...
      <div class="text-center p-2 m-2">
        ...
        <button type="submit" class="btn logout-btn fs-4">
          <router-link to="/logout">Logout</router-link>
        </button>
        <button
          type="submit"
          class="btn delete-btn fs-4"
